...
import org.example.Entity.Facilities;
...
public class FacilityModel {
    ...
    private FacilityViewModel convertToFacilityViewModel (Facilities facilities){
        return new FacilityViewModel(facilities.getFacilityId(), facilities.getObjectReferenceId(), facilities.getMinBedrooms(),
                facilities.getMinBathrooms(), facilities.getGarage(), facilities.getGarden(), facilities.getPool());
    }
