...
public class ObjectModel {
    private static final Logger logger =
            Logger.getLogger(ObjectModel.class.getName());
    @Getter
    private final ObservableList<ObjectViewModel> objectViewModels =
    ...
    private void fetchDataFromDatabase() {
        try (Session session = sessionFactory.openSession()) {
            ...
            List<Object> objectList = session.createQuery("from Object",
                    Object.class).list();
